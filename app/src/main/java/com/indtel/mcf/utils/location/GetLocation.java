package com.indtel.mcf.utils.location;
...
public class GetLocation extends Service implements LocationListener {
    ...
    public Location getLocation() {
        try {
            ...
            //Toast.makeText(mContext, "getLocation function", Toast.LENGTH_SHORT).show();
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isNetworkEnabled) {
                    ...
                    //Toast.makeText(mContext, "Network function", Toast.LENGTH_SHORT).show();
                    if (locationManager != null) {
                        ...
                        if (location != null) {
                           ...
                           //  Toast.makeText(mContext, "Latitude0 = "+latitude +" Longitude0 = "+longitude, Toast.LENGTH_SHORT).show();
                        }
                    }
                }
