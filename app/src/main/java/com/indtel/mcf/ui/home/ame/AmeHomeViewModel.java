 ...
 */
public class AmeHomeViewModel extends BaseViewModel<AmeHomeNavigator> {
    public final ObservableField<String> userName;

    public AmeHomeViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
    ...
    public void onCaseForRecommendationClick(){
        getNavigator().onCaseForRecommendationClick();
    }
