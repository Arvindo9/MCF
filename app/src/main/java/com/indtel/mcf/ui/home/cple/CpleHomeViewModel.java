 ...
 */
public class CpleHomeViewModel extends BaseViewModel<CpleHomeNavigator> {

    public final ObservableField<String> userName;

    public CpleHomeViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
    ...
    public void onCasesForApprovalRejectionClick(){
        getNavigator().onCasesForApprovalRejectionClick();
    }
